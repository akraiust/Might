var mightApp = angular.module('mightApp', ['ngRoute']);

// configure our routes
mightApp.config(function ($routeProvider, $locationProvider) {
//	$locationProvider.hashPrefix('!').html5Mode(true);
//	$locationProvider.baseHref = "/might/";
    $routeProvider
        ...
        .when('/changePassword', {
         ...
         .when('/homeTestData', {
              templateUrl: 'view/homeTestData.html',
              controller: 'mainController'
          });
...
mightApp.directive('validPasswordC', function () {
    return {
        require: 'ngModel',
   ...
   *
   */
  mightApp.directive('scrollToEnd', function ($window) {
...
mightApp.constant('News_Web_Source','NEWS,WEB');
mightApp.constant('Twitter_Fb_Source','TWITTER,FACEBOOK');
mightApp.constant('NumberOfRecords',50);
mightApp.constant('BASE_URL','https://excitenewsuat.ust-global.com/social-webservices/');

mightApp.factory('dataService', function() {
	  var _dataObj = {};
	  return {
	    dataObj: _dataObj
	  };
...
mightApp.factory('getSubCategoriesService', function($http) {
	//var BASE_URL1= 'http://localhost:8080/social-webservices/';
	var BASE_URL1= 'https://excitenewsuat.ust-global.com/social-webservices/';
return {
	
getTrendingSubCategories: function(selectedCategory,date) {
	console.log(BASE_URL1+'rest/user/post/GetTrendingSubCategory?category='+selectedCategory+'&date='+date);
return $http.get(BASE_URL1+'rest/user/post/GetTrendingSubCategory?category='+selectedCategory+'&date='+date);
}
}
});

/*mightApp.constant('BASE_URL','http://socialedge.cloudapp.net:8080/might-webservices/');*/
